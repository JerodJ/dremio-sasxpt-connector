...
@SourceType(value = "SASXptARP", label = "SASXpt",uiConfig = "sasxpt-layout.json")
public class SASXptConf extends AbstractArpConf<SASXptConf> {
  private static final String ARP_FILENAME = "arp/implementation/sasxpt-arp.yaml";
  private static final ArpDialect ARP_DIALECT =
      AbstractArpConf.loadArpFile(ARP_FILENAME, (ArpDialect::new));
  private static final String DRIVER = "cdata.jdbc.sasxpt.SASXptDriver";
